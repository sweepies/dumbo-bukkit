...
public class Locale {
    ...
    public static String ERR_UnableToCreateDataFolderWithException = "Unable to create data directory: ";
    public static String ERR_UnableToFetchQuotes = "Unable to fetch quotes.";
    public static String QUOTES_FetchingQuotes = "Fetching quotes from GitHub..";
